    ...
    render() {
        return (
            <div style={{display: "unset"}}>
                <div id="side-bar-nav" className="bg-dark">
                    <div className="sidebar-heading"><strong><h2 className="text-center text-primary">Welcome,<br/> @{sessionStorage.getItem('user_name')}!</h2></strong></div>
                                    ...
                                    <div className="logo-side-bar">
                                        <div style={{marginRight: "%"}}>
                                            <svg width="1em" height="1em" viewBox="0 0 16 16"
                                                 className="bi bi-shield-exclamation" fill="white"
